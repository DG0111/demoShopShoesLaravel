        ...
        <div class="card">
            <div class="card-body">
                <form id="example-vertical-wizard" class="formAddProduct" enctype="multipart/form-data"
                      action="{{url('admin/product/'.$pro->id)}}" method="POST">
                    {{ method_field('PUT') }}
                    {{ csrf_field() }}
                    <div role="application" class="wizard clearfix vertical" id="steps-uid-1">
                        <div class="content clearfix p-3">
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    value="@if(!old('name')){{$pro->name}}@else{{old('name')}}@endif"
                                    name="name"
                                    type="text"
                                    class="form-control">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control"
                                          name="description">@if(!old('description')){{$pro->description}}@else{{old('description')}}@endif</textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    value="@if(!old('promotion_price')){{$pro->promotion_price}}@else{{old('promotion_price')}}@endif"
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    value="@if(!old('quantity')){{$pro->quantity}}@else{{old('quantity')}}@endif"
                                    name="quantity"
                                    type="number"
                                    class="form-control">
                            </div>
                            ...
                            <table class="table table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" name="size[]"
                                               @if(!old('size'))
                                               @if(is_array($size) && in_array(35,$size))
                                               checked
                                               @endif
                                               @eles
                                               @if(is_array(old('size')) && in_array(35, old('size')))
                                               checked
                                               @endif
                                               @endif
                                               value="35">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" name="size[]"
                                               @if(!old('size'))
                                               @if(is_array($size) && in_array(36,$size))
                                               checked
                                               @endif
                                               @eles
                                               @if(is_array(old('size')) && in_array(36, old('size')))
                                               checked
                                               @endif
                                               @endif
                                               value="36">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" name="size[]"
                                               @if(!old('size'))
                                               @if(is_array($size) && in_array(37,$size))
                                               checked
                                               @endif
                                               @eles
                                               @if(is_array(old('size')) && in_array(37, old('size')))
                                               checked
                                               @endif
                                               @endif
                                               value="37">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" name="size[]"
                                               @if(!old('size'))
                                               @if(is_array($size) && in_array(38,$size))
                                               checked
                                               @endif
                                               @eles
                                               @if(is_array(old('size')) && in_array(38, old('size')))
                                               checked
                                               @endif
                                               @endif
                                               value="38">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" name="size[]"
                                               @if(!old('size'))
                                               @if(is_array($size) && in_array(39,$size))
                                               checked
                                               @endif
                                               @eles
                                               @if(is_array(old('size')) && in_array(39, old('size')))
                                               checked
                                               @endif
                                               @endif
                                               value="39">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" name="size[]"
                                               @if(!old('size'))
                                               @if(is_array($size) && in_array(40,$size))
                                               checked
                                               @endif
                                               @eles
                                               @if(is_array(old('size')) && in_array(40, old('size')))
                                               checked
                                               @endif
                                               @endif
                                               value="40">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" name="size[]"
                                               @if(!old('size'))
                                               @if(is_array($size) && in_array(41,$size))
                                               checked
                                               @endif
                                               @eles
                                               @if(is_array(old('size')) && in_array(41, old('size')))
                                               checked
                                               @endif
                                               @endif
                                               value="41">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" name="size[]"
                                               @if(!old('size'))
                                               @if(is_array($size) && in_array(42,$size))
                                               checked
                                               @endif
                                               @eles
                                               @if(is_array(old('size')) && in_array(42, old('size')))
                                               checked
                                               @endif
                                               @endif
                                               value="42">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" name="size[]"
                                               @if(!old('size'))
                                               @if(is_array($size) && in_array(43,$size))
                                               checked
                                               @endif
                                               @eles
                                               @if(is_array(old('size')) && in_array(43, old('size')))
                                               checked
                                               @endif
                                               @endif
                                               value="43">
